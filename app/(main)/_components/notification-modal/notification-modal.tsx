...
import { AccountIcon, CloseCircle, ProfileCircleIcon } from '../icon/icon'
...
export const NotificationModal = ({ setSelected }) => {
    ...
    return (
        ...
        >
            <div className='w-[494px] h-full absolute right-0 bg-background rounded-s-2xl py-4 px-7 shadow-[0px_0px_4px_0px_#B9B9B940]'>
